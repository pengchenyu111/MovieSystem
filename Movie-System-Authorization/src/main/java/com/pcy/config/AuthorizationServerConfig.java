 ...
 * <p>
 * 获取外部token：
 * http://127.0.0.1:9999/oauth/token?grant_type=password&username=18224464804&password=123456&login_type=general_user_type
 * 获取内部token
 * http://127.0.0.1:9999/oauth/token?grant_type=client_credentials
 *
 * @author PengChenYu
 */
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    private static final String OUTSIDE_AUTH_NAME = "moviesystem-outside-api";
    private static final String OUTSIDE_AUTH_SECRET = "moviesystem";
    private static final String INSIDE_AUTH_NAME = "moviesystem-inside-api";
    private static final String INSIDE_AUTH_SECRET = "moviesystem";
