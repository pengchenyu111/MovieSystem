...
public class MailService {
     ...
     */
    @GlobalTransactional
    public boolean singleSendMailTo(MailMessageVo mailMessage, String txId) throws Exception {
     ...
     * @throws Exception
     */
    private MailSendRecord singleSendMail(MailMessageVo mailMessage, String txId) throws Exception {
